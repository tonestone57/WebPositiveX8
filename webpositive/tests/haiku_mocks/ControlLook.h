...
public:
    ...
    void DrawLabel(BView* owner, const char* label, BRect rect, const BRect& updateRect, rgb_color base, uint32 flags, const BAlignment& alignment, const rgb_color* textColor = NULL) {}
